...
TASK_NAME_BY_MODALITY = {
    "text": "app.tasks.score_text",
    "image": "app.tasks.score_image",
    "video": "app.tasks.score_video",
    "audio": "app.tasks.score_audio",
}
...
app = FastAPI(
    ...
    version="2.0.0",
    description="Asynchronous multimodal scoring API with background workers.",
)
