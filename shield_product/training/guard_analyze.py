...
def main() -> None:
    ...
    logger.info("Guard analysis complete")
    ...
    logger.info("Average viral harm potential: %s", summary["average_viral_harm_potential"])
    ...
    logger.info("Insufficient evidence videos: %s", summary["insufficient_evidence_count"])
