    ...
    def extract(
        ...
        *,
        ...
        signals = extract_reel_signals(
            ...
            keyframe_interval_seconds=float(keyframe_interval_seconds),
    ...
    def score(self, combined_text: str) -> SemanticResult:
        ...
        return SemanticResult(
            ...
            engine_details={
                ...
                "used_hate_classifier": bool(result.used_hate_classifier),
                "hate_classifier_score": float(result.hate_classifier_score),
